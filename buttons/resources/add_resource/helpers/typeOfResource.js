...
const addNew = require('./newResourceType');
const createResource = require('./createResource');
const EmbedInfo = require("./EmbedInfo");

const typeOfResource = async (interaction, guild, providerData) => {
    ...
    resourceTypeCollector.on('collect', async (btnInteraction) => {
        ...
        if(value === 'add_new')
        {
            addNew(btnInteraction, guild, providerData)
        } else {
            const embedData = new EmbedInfo(value, '#808080', guild)
